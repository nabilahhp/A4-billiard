...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item ">
              <a class="nav-link active" aria-current="page" href="#ramai">Ramai</a>
            </li>
            <li class="nav-item">
            ...
            if (isset($_SESSION['id_user'])) {
              ...
              <li><a class="dropdown-item" href="user/lapangan.php">Meja</a></li>
              <li><a class="dropdown-item" href="user/makanan.php">Makanan</a></li>
              </ul>
              </li>
            ';
            }
  ...
  <section class="about" id="about">
    ...
    <div class="row">
      ...
      <div class="contain" data-aos="fade-left" data-aos-duration="1000">
        ...
        <p>Sport Center adalah pusat olahraga yang menyediakan berbagai fasilitas dan layanan penyewaan lapangan untuk
          berbagai jenis olahraga. Tempat ini dirancang untuk memfasilitasi kegiatan olahraga dan rekreasi bagi
          individu, kelompok, dan komunitas yang memiliki minat dalam berpartisipasi dalam aktivitas fisik. Sport Center
          menawarkan beragam jenis lapangan yang dapat disewa untuk berbagai jenis olahraga, seperti sepak bola, futsal,
          tenis, basket, voli, dan masih banyak lagi. Setiap lapangan dilengkapi dengan fasilitas yang sesuai, termasuk
          garis-garis permainan, jaring, dan peralatan yang dibutuhkan untuk menjalankan aktivitas olahraga dengan
          lancar.</p>
      </div>
    </div>
  </section>
  ...
  <section class="pembayaran" id="bayar">
    ...
    <ul class="border list-group list-group-flush mt-5">
      <li class="list-group-item">1. Pengguna harus membuat akun atau mendaftar sebagai anggota pada website Sport
        Center.</li>
      <li class="list-group-item">2. Pengguna dapat memilih jenis lapangan yang ingin dipesan, memilih tanggal dan waktu
        tertentu.</li>
      <li class="list-group-item">3. Pengguna harus memilih tanggal dan waktu, melihat harga sewa lapangan, mengisi
        jumlah jam atau durasi, melengkapi formulir pemesanan.</li>
      ...
      <li class="list-group-item">5. Setelah status sudah di setujui, silahkan datang ke Sport Center sesuai jadwal yang
        di pesan</li>
    </ul>
  </section>
  <!-- End Pembayaran -->
  ...
  <footer>
    ...
    <div class="credit">
      <p>Created by <a href="#">Kelompok 5</a> &copy; 2023</p>
    </div>
  </footer>
  <!-- End Footer -->
